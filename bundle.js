...
var _forecast_container = __webpack_require__(25);

var _forecast_container2 = _interopRequireDefault(_forecast_container);
...
var Root = function Root() {
  return _react2.default.createElement(
    'main',
    null,
    _react2.default.createElement(_forecast_container2.default, null),
...
var _forecast_item = __webpack_require__(26);

var _forecast_item2 = _interopRequireDefault(_forecast_item);
...
var ForecastContainer = function (_React$Component) {
  _inherits(ForecastContainer, _React$Component);

  function ForecastContainer(props) {
    _classCallCheck(this, ForecastContainer);

    var _this = _possibleConstructorReturn(this, (ForecastContainer.__proto__ || Object.getPrototypeOf(ForecastContainer)).call(this));
    ...
    // style as a callback
    _this.toggleTempScale = _this.toggleTempScale.bind(_this);
    return _this;
  }

  _createClass(ForecastContainer, [{
    ...
    value: function componentDidMount() {
      ...
      xmlhttp.onreadystatechange = function () {
        if (xmlhttp.status === 200 && xmlhttp.readyState === XMLHttpRequest.DONE) {
          ...
          var forecast = data.response[0].periods;
          _this2.setState({ weather: forecast });
        }
      };
    ...
    key: 'parseWeather',
    value: function parseWeather() {
      var _this3 = this;

      return Object.values(this.state.weather).map(function (day, idx) {
        var high = void 0,
            low = void 0;

        if (_this3.state.celsius) {
          high = day.maxTempC + ' \xB0C';
          low = day.minTempC + ' \xB0C';
        } else {
          high = day.maxTempF + ' \xB0F';
          low = day.minTempF + ' \xB0F';
        }

        return _react2.default.createElement(_forecast_item2.default, {
          key: idx,
    ...
    key: 'toggleTempScale',
    value: function toggleTempScale() {
    ...
    value: function render() {
      var componentBody = void 0;

      if (this.state.weather) {
        componentBody = _react2.default.createElement(
          'div',
      ...
      var buttonText = this.state.celsius ? 'show farenheit' : 'show celsius';
...
var ForecastItem = function ForecastItem(_ref) {
  var date = _ref.date,
      high = _ref.high,
      low = _ref.low,
